...
<div class="maintenance">
  <div class="maintenance_contain">
    <img src="{{ asset('images/logo.png') }}" style="width: 100px" alt="maintenance">
    
    <div class="pp-infobox-title-wrapper">
		  <h3 class="pp-infobox-title">Sorry, this site will no longer be accessible</h3>
	  </div> 
  <div class="pp-infobox-description">
		<p>This site is now down. We have migrated it to a new URL. <br> Kindly visit the new URL instead <a href="https://pis.ncca.gov.ph/tracker">https://pis.ncca.gov.ph/tracker</a>. </p>			</div>    
